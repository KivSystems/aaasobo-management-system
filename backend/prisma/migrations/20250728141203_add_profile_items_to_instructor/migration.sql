/*
  ...
  - Added the required column `messageForChildren` to the `Instructor` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "messageForChildren" TEXT NOT NULL,
