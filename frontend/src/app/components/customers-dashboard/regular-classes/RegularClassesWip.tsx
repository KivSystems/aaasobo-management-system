...
import CurrentSubscriptionWip from "@/app/components/customers-dashboard/regular-classes/CurrentSubscriptionWip";
import AddSubscription from "@/app/components/customers-dashboard/regular-classes/AddSubscription";
import Loading from "../../elements/loading/Loading";

function RegularClassesWip({
  adminId,
  customerId,
...
export default RegularClassesWip;
